package cn.memoryzy.deepSeek.bundle;
 ...
 * @since 2025/2/13
 */
public class DeepSeekAssistantBundle extends AbstractBundle {

    private static final Logger LOG = Logger.getInstance(DeepSeekAssistantBundle.class);

    private static final String BUNDLE = "messages.DeepSeekAssistantBundle";
    ...
    private static final DeepSeekAssistantBundle INSTANCE = new DeepSeekAssistantBundle(BUNDLE);

    public DeepSeekAssistantBundle(@NonNls @NotNull String pathToBundle) {
        super(pathToBundle);
