...
import cn.memoryzy.deepSeek.ui.dialog.SupportDialog;
...
public class DonateAction extends DumbAwareAction implements CustomComponentAction {
    ...
    public DonateAction() {
        ...
        presentation.setText(DeepSeekAssistantBundle.messageOnSystem("action.donate.text"));
        presentation.setDescription(DeepSeekAssistantBundle.messageOnSystem("action.donate.description"));
        presentation.setIcon(DeepSeekAssistantIcons.DONATE);
    }
        ...
        ActionButton button = new ActionButton(this, presentation, place, ActionToolbar.DEFAULT_MINIMUM_BUTTON_SIZE) {
            ...
            protected void updateToolTipText() {
                ...
                new HelpTooltip()
                        ...
                        .setDescription(DeepSeekAssistantBundle.messageOnSystem("tooltip.donate.description"))
                        .installOn(this);
            }
        };
